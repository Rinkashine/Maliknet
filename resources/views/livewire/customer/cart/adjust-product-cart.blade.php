            ...
            <form wire:submit.prevent="UpdateProductQuantity">
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12">
                        @csrf
                        <label for="pos-form-1" class="form-label">Quantity:   </label>
                        <input type="number" min="1" id="adjustquantity" wire:model.lazy="quantity" class="form-control flex-1 @error('quantity') border-danger @enderror" placeholder="Quantity" onkeypress="return event.charCode >= 48">
