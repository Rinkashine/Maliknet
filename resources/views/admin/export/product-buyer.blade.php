...
<html>
<head>
    <title>{{ $product_name }} - Buyer</title>
</head>
<style type="text/css">
    @page {
...
<body class="pt-x-50">
    ...
    <main>
        <div class="w-100" style="margin-bottom:10px">
            <div>
                <h3 class="text-center header-title">{{ $product_name }} - Buyer </h3>
            ...
            <table class="table w-100">
                <thead>
                    <tr class="text-white">
                        ...
                        <th class="w-50 th-color-dark">Total Quantity</th>
                    </tr>
                </thead>
               <tbody>
                    @foreach($customers as $customer)
                        <tr class="stripe">
                            ...
                            <td  class="text-center">{{ number_format($customer->total_quantity) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
