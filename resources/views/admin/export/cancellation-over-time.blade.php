...
<html>
<head>
    <title>Cancellations Over Time</title>
</head>
<style type="text/css">
    @page {
...
<body class="pt-x-50">
    ...
    <main>
        <div class="w-100" style="margin-bottom:10px">
            <div>
                <h3 class="text-center header-title">Cancellations Over Time </h3>
        ...
        <div>
            <table class="table w-100">
                <thead>
                    <tr class="text-white">
                        <th class="w-50 th-color-dark">Year</th>
                        <th class="w-50 th-color-dark">Month</th>
               ...
               <tbody>
                    @foreach($orders as $order)
                        <tr class="stripe">
                            <td class="text-center">{{ $order->year }}</td>
                            <td class="text-center">{{ $order->month }}</td>
