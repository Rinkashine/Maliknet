...
<body class="pt-x-50">
    ...
    <main>
        <div class="w-100" style="margin-bottom:10px">
            <div>
                <h3 class="text-center header-title">Account Verification </h3>
            ...
            <table class="table w-100">
               ...
               <tbody>
                    <tr class="stripe">
                        ...
                        <td  class="text-center">{{ number_format($verified) }}</td>
                    </tr>
                    <tr class="stripe">
                        <td class="text-center">Non Verified</td>
                        <td  class="text-center">{{ number_format($nonverified) }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
