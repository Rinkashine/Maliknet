...
<body class="pt-x-50">
    ...
    <main>
        <div class="w-100" style="margin-bottom:10px">
            <div>
                <h3 class="text-center header-title">{{ $monthYear }} Customers </h3>
            ...
            <table class="table w-100">
                <thead>
                    <tr class="text-white">
                        ...
                        <th class="w-50 th-color-dark">Created At</th>
                    </tr>
                </thead>
               <tbody>
                    @foreach($customers as $customer)
                        <tr class="stripe">
                            ...
                            <td class="text-center">{{ $customer->created_at->toDayDateTimeString() }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
