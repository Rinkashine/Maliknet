...
<html>
<head>
    <title>Reasons For Cancellation</title>
</head>
<style type="text/css">
    @page {
...
<body class="pt-x-50">
    ...
    <main>
        <div class="w-100" style="margin-bottom:10px">
                <div>
                    <h3 class="text-center header-title">Reasons For Cancellation </h3>
        ...
        <div>
            <table class="table w-100">
                <thead>
                    <tr class="text-white">
                        <th class="w-50 th-color-dark">Reason</th>
               ...
               <tbody>
                    @foreach($reasons as $reason)
                        <tr class="stripe">
                            <td>{{ $reason->name }}</td>
                            <td class="text-center" style="font-family: DejaVu Sans; font-size: 0.8rem;">{{ number_format($reason->total) }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
