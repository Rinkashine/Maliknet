          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 0;">
            <tr>
              <td class="email-masthead" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; text-align: center; padding: 25px 0;" align="center">
                <a href="https://maliknet.com/" class="f-fallback email-masthead_name" style="color: #A8AAAF; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                </a>
              </td>
            </tr>
            <!-- Email Body -->
                  ...
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                      <div class="f-fallback">
                        ...
                        <p>
                            Your order #{!! $order_id !!} has been prepared and ready for delivery. We will send a notification once your order is out for delivery.
                        </p>
                        <p>
                        ...
                        <table border="0" cellspacing="0" width="100%">
                            <tr>
                              <td>
                                <h3 style="font-size: 22px; font-weight: bold; text-align: left;">Items in this shipment</h3>
                                <table  border="0" cellspacing="0" width="100%">
                                    <tbody>
