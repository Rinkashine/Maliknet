          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 0;">
            <tr>
              <td class="email-masthead" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; text-align: center; padding: 25px 0;" align="center">
                <a href="http://127.0.0.1:8000/" class="f-fallback email-masthead_name" style="color: #A8AAAF; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                    {{ env('APP_NAME') }}
              </a>
              </td>
            </tr>
                  ...
                  <tr>
                    <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                      <div class="f-fallback">
                        <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;" align="left">Thanks for shopping with us!</h1>
                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">
                            Hi  {!! $name !!},
                        </p>
                        <p>
                            We received your #{!! $orderid !!} on {!! $updated_at->toDayDateTimeString()    !!} and you’ll be paying for this via
                            @if($payment_method == "Paid by Paypal")
                                Paypal
                            @else
                                {!! $payment_method !!}
                            @endif
                        ...
                        <table>
                          <tr>
                            <td>
                              <h3 style="font-size: 22px; font-weight: bold; text-align: left;">Delivery Details</h3>
                              <table>
                                <tbody>
                                    <tr>
                                        <td>Name:</td>
                        ...
                        <table border="0" cellspacing="0" width="100%">
                            <tr>
                              <td>
                                <h3 style="font-size: 22px; font-weight: bold; text-align: left;">Items</h3>
                                <table  border="0" cellspacing="0" width="100%">
                                    <tbody>
                                        @foreach ($items as $item)
                                            <tr>
                                                <td width="350">{{ $item->product_name }}</td>
                                                <td width="350">{{ $item->quantity }}pcs</td>
                                                <td width="350">₱{{ $item->price }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                          ...
                          <table border="0" cellspacing="0" width="100%">
                            <tr>
                              <td>
                                <h3 style="font-size: 22px; font-weight: bold; text-align: left;">Cost</h3>
                                <table  border="0" cellspacing="0" width="100%">
                                    <tbody>
                                        <tr>
                ...
                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="width: 570px; -premailer-width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; text-align: center; margin: 0 auto; padding: 0;">
                  <tr>
                    <td class="content-cell" align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                      <p class="f-fallback sub align-center" style="font-size: 13px; line-height: 1.625; text-align: center; color: #A8AAAF; margin: .4em 0 1.1875em;" align="center">© 2024. {{ config('app.name') }} All rights reserved.</p>
